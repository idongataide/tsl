    ...
    <div class="container">               
        <div class="row align-items-center">
            ...
            <div class="col-xl-5 col-lg-5 offset-lg-1" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
               ...
               <p data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>As an experienced professional in TML, this comes with the responsibility to uphold higher standards of conduct, ethics, and communication in both personal and professional interactions. </p> 
            ...
            <div class="col-12 col-md-6 position-relative order-1 order-md-2">
                <div class="position-absolute left-0px bottom-0px bg-white z-index-9 p-65px md-p-40px w-360px d-none d-md-block">
                    ...
                    <div class="fancy-text-style-3">
                        <h4 class="lh-40 alt-font text-dark-gray fw-600 ls-minus-2px image-mask cover-background mb-0" style="background-image: url('<?php echo base_url(); ?>/assets/img/careers/profesionals.webp');')">Unlock your potential at TML</h4>
                    </div>
                </div>
                <div class="swiper h-100 banner-slider sm-h-450px swiper-light-pagination" data-slider-options='{ "slidesPerView": 1, "loop": true, "pagination": { "el": ".swiper-pagination-bullets", "clickable": true }, "navigation": { "nextEl": ".slider-one-slide-next-1", "prevEl": ".slider-one-slide-prev-1" }, "autoplay": { "delay": 4000, "stopOnLasTMLide": true, "disableOnInteraction": false },"keyboard": { "enabled": true, "onlyInViewport": true }, "effect": "fade" }'>
    ...
    <div class="container overlap-gap-section">
        <div class="row align-items-center mb-4">
            <div class="col-xl-6 lg-mb-30px text-center text-xl-start">
                <h3 class="alt-font text-dark-gray fw-600 ls-minus-3px mb-2">Discover more <br/> about working with TML</h3>
