...
<section class="background-repeat pt-0- bg-light" >
    <div class="container"> 
        <div class="row justify-content-center align-items-center blockquote-style-03">            
            <div class="col-xl-11 col-lg-11 col-md-12 offset-lg-1">
                ...
                <div class="border-radius-50px h-500px md-h-450px sm-h-350px d-flex align-items-end justify-content-center overflow-hidden cover-background skrollr-zoom  xs-pb-12" >
                    ...
                    <div class="row justify-content-center position-absolute bottom30">
                        ...
                        <div class="col-xl-5 col-lg-3 position-relative z-index-1 text-center animation-zoom">
                            <a href="https://www.youtube.com/watch?v=lop6t2QSZLs" class="position-relative d-inline-block text-center border border-3 border-color-transparent-white-very-light rounded-circle video-icon-box video-icon-large popup-youtube">
                                <span>
...
<section class="stack-box py-0 z-index-99" id="diversity"> 
                        ...
                        <div class="col-lg-6 cover-background overflow-visible h-100 md-h-500px" style="background-image: url('<?php echo base_url(); ?>/assets/img/careers/staffs.jpg')">
                            ...
                            <div class="position-absolute right-0px bottom-minus-1px">
                                <div class="vertical-title-center">
                                    <div class="title fw-700 fs-15 ls-2px alt-font text-uppercase text-dark-gray bg-white pt-30px pb-30px ps-10px pe-10px">
                                        <span class="d-inline-block">Bemore</span>
                                    </div>
                                </div>
                            </div>
                        </div>
