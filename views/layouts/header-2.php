                        ...
                        <div class="collapse navbar-collapse" id="navbarNav"> 
                            <ul class="navbar-nav fw-600">
                               <?php
                                ...
                                <li class="nav-item"><a href="https://tsllog.tsllogisticsltd.com/" class="nav-link fw-600 fs-18">TSL Logistics Limited</a></li> 
                                <li class="nav-item"><a href="https://tml.tsllimited.com/" class="nav-link fw-600 fs-18">TSL Metroline Limited</a></li>
                                <li class="nav-item ">
                                    <a href="<?php echo base_url(); ?>/home" class="nav-link fw-600 fs-18">
