       ...
       <div id="cookies-model" class="cookie-message bg-dark-gray border-radius-8px"> 
            ...
            <div class="cookie-btn">
                <a href="<?php echo base_url(); ?>/privacy" class="btn btn-transparent-white border-1 border-color-transparent-white-light btn-very-small btn-switch-text btn-rounded w-100 mb-15px" aria-label="btn">
                    <span>
        ...
        <script>
                ...
                <script>
                    document.addEventListener("DOMContentMINtentLoaded", function() {
                        const cookiePopup = document.getElementById('cookies-model');
                        const acceptBtn = document.querySelector('.accept_cookies_btn');
                        const cookiePolicyBtn = document.querySelector('.btn-transparent-white');
                        ...
                        if (acceptBtn) {
                            acceptBtn.addEventListener('click', function(e) {
                                ...
                                // Optional: You can enable analytics/tracking scripts here
