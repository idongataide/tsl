...
<section class="page-title-big-typography breadcrumbs bg-dark-gray ipad-top-space-margin cover-background md-py-0" style="background-image: url(<?php echo base_url(); ?>/assets/img/transport.webp)"> 
            ...
            <div class="row align-items-center small-screen">
                <div class="col-lg-12 col-sm-12 position-relative page-title-extra-small">
                    ...
                    <h2 class="m-auto pb-5px pt-5px t-light fw-600 ls-minus-1px overflow-hidden">
                        <span class="d-inline-block" data-anime='{ "translateY": [30, 0], "opacity": [0, 1], "easing": "easeOutCubic", "duration": 500, "staggervalue": 300, "delay": 200 }'>Dry Van and Flatbed Trucking</span>
                    </h2>
                </div> 
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 order-1 order-lg-2 md-mb-50px" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    <h4 class="text-dark-gray fw-600 ls-minus-1px alt-font mb-20px d-block" data-fancy-text='{ "opacity": [0, 1], "translateY": [50, 0], "string": ["Dry Van and Flatbed Trucking"], "duration": 500, "delay": 200, "speed": 10, "easing": "easeOutQuad" }'></h4>
                    <p data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>TSL offers a comprehensive range of transportation solutions through both dry van and
                        flatbed trucking services, ensuring flexibility and reliability for various cargo types.
                        Our dry van trucking service provides secure, enclosed transport for goods that require
                        protection from weather and external elements, such as containerized products, heavy
                        sacks, and palletized freight. For larger, irregularly shaped cargo, our flatbed trucking
                        service offers open-air transport, ideal for oversized goods that need easy loading and
                        unloading.
                    </p>
                    <img src="<?php echo base_url(); ?>/assets/img/transport.webp" class="mt-30px mb-30px md-mt-15px border-radius-6px" alt="">
                    <p data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        Both services are supported by advanced logistics technology, optimizing routes for
                        "Safely On Time and In Full" (SOTIF) deliveries. Our highly trained drivers ensure that every
                        shipment, whether enclosed or open, reaches its destination securely and efficiently,
                        providing a cost-effective and dependable solution for your transportation needs.
                    </p>
                </div>
            </div>
        </div> 
