...
<section class="page-title-big-typography breadcrumbs bg-dark-gray ipad-top-space-margin cover-background md-py-0" style="background-image: url(<?php echo base_url(); ?>/assets/img/service/Freight.webp)"> 
            ...
            <div class="row align-items-center small-screen">
                <div class="col-lg-12 col-sm-12 position-relative page-title-extra-small">
                    ...
                    <h2 class="m-auto pb-5px pt-5px t-light fw-600 ls-minus-1px overflow-hidden">
                        <span class="d-inline-block" data-anime='{ "translateY": [30, 0], "opacity": [0, 1], "easing": "easeOutCubic", "duration": 500, "staggervalue": 300, "delay": 200 }'>Freight Forwarding & Brokerage</span>
                    </h2>
                </div> 
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 order-1 order-lg-2 md-mb-50px" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    ...
                    <p data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        clearance, and regulatory compliance, we ensure that your shipments move smoothly and efficiently
                        through each stage of the supply chain.
                    </p>
                    <img src="<?php echo base_url(); ?>/assets/img/service/Freight.webp" class="mt-30px mb-30px md-mt-15px border-radius-6px" alt="">
                    <p data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        Through our freight brokerage services, we connect you with a trusted network of carriers, negotiating
                        competitive rates and providing tailored transportation solutions, whether you need full truckload
                        (FTL), less-than-truckload (LTL), or multimodal options.
                        Together, our freight forwarding and brokerage services offer a seamless, cost-effective logistics
                        solution, ensuring that your goods are delivered on time, within budget, and with the highest level of
                        care.
                    </p>
                </div>
            </div>
